...
> v2.0 相对 v1 的变化：从「单一领域的内容编排」升级为「多 curator 的个人知识整理」，并把《Harness 工程之道》第 4 章的子 agent 工程原则系统落到架构里（详见 [HARNESS-PRINCIPLES.md](HARNESS-PRINCIPLES.md)）。
...
## 2. Harness 工程基础（落到架构里的子 agent 原则）
